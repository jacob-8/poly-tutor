...
<div class="sm:max-w-470px">
  <a class="block mb-1 relative overflow-hidden h-0 pb-56.25% sm:rounded" style="view-transition-name: yt-thumbnail-{youtube.id}" {href}>
    <img class="w-full absolute centered" src="https://i.ytimg.com/vi/{youtube.id}/sddefault.jpg" alt={title} title={youtube.description.map(sentence => sentence.text).join(' ')} />
