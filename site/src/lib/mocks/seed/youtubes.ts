...
export const xiao_bai_channel: TablesInsert<'youtube_channels'> = {
  id: 'UC-7jKPgRmLBiB1ltbABubNA',
  title: '小白的奇幻旅行',
  thumbnail_url: 'https://yt3.ggpht.com/ytc/APkrFKav44IZWeQMQttWjk2AsDi8oLkP1Mnf6zgIVu8s'
}

export const freeCodeCamp_channel: TablesInsert<'youtube_channels'> = {
  id: 'UC8butISFwT-Wl7EV0hUK0BQ',
  title: 'freeCodeCamp.org',
...
export const youtubes_with_data = {
