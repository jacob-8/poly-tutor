...
export const jieba_cut: (text: string, hmm: boolean) => string[] = cut

if (import.meta.vitest) {
  describe(jieba_cut, () => {
    test('你好世界！', () => {
      expect(jieba_cut('你好世界！', true)).toEqual([
        '你好',
        '世界',
        '！',
      ])
    ...
    test('中华人民共和国武汉市长江大桥', () => {
      expect(jieba_cut('中华人民共和国武汉市长江大桥', true)).toEqual([
        '中华人民共和国',
        '武汉市',
        '长江大桥',
      ])
      ...
      expect(cut_all('中华人民共和国武汉市长江大桥')).toEqual([
        '中',
        '中华',
        '中华人民',
        '中华人民共和国',
