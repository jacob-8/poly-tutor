...
('UC-7jKPgRmLBiB1ltbABubNA', 'A video that has no captions on YouTube, but captions were transcribed using Whisper. Then a summary was added.', 614.2, '9ruqSX_p_48', 'zh', '自驾游贵州黔东南，花50元买了个竹篓，是不是特别洋气？【小白的奇幻旅行】'),
('UC-7jKPgRmLBiB1ltbABubNA', 'A video that has no captions on YouTube, but captions were transcribed using Whisper.', 534, 'UnlyETVcDzY', 'zh', 'An Elder Transforms a Village by Bringing Back 200 Apple Saplings with a Donkey – Truly Amazing!'),
('UC-7jKPgRmLBiB1ltbABubNA', 'description here...', 631, 'GlctfUFhbaM', 'zh', '在黄土高坡上，老奶奶打造出美丽乡村院落，美得像世外桃源啊【小白的奇幻旅行】'),
('UC8butISFwT-Wl7EV0hUK0BQ', 'description here...', 5940, 'HSZ_uaif57o', 'en', 'Learn LangChain.js - Build LLM apps with JavaScript and OpenAI'),
